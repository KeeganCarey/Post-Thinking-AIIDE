...
DATASET_ID = "chimbiwide/NPC-RP-No-Thinking"
CONDITION = "no-thinking"
GCS_BUCKET = "gs://tpu-aiide"
LOCAL_LOG_DIR = f"/tmp/tunix_logs/{CONDITION}"
GCS_LOG_DIR = f"{GCS_BUCKET}/logs/{CONDITION}"
BATCH_SIZE = 2
MAX_LENGTH = 4096
RANK = 64
ALPHA = 128.0
...
logging_options = metrics_logger.MetricsLoggerOptions(
    log_dir=LOCAL_LOG_DIR, flush_every_n_steps=10
)
